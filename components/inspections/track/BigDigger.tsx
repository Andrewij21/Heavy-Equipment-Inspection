...
export const trackFormSections = [
  ...
  {
    title: "Measure Cylinder Temperature (Pengukuran Temperatur Silinder)",
    fields: [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "cabinGauge", label: "Gauge", type: "result" },
      {
  ...
  },
  {
    title: "",
    fields: [
      { name: "topUpCoolantQty", label: "Coolant", type: "qty" },
      { name: "topUpEngineQty", label: "Engine (15W-40)", type: "qty" },
      {
        name: "topUpHydraulicQty",
        label: "Hydraulic (TURALIK 46)",
        type: "qty",
      },
      {
        name: "topUpSwingMachineryQty",
        label: "Swing Machinary (HD 50)",
        type: "qty",
      },
      {
        name: "topUpFinalDriveQty",
        label: "Final Drive (HD 50)",
        type: "qty",
      },
    ],
  },
