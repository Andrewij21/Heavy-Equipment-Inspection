...
export const trackFormSections = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "cabinSwitches", label: "Saklar (Switches)", type: "result" },
      { name: "cabinGauge", label: "Jarum Penunjuk (Gauge)", type: "result" },
      {
      ...
      { name: "cabinHorn", label: "Klakson (Horn)", type: "result" },
